...
print("Fetching apisou site pages...", flush=True)
...
print(f"Found {len(apisou_slugs)} apisou pages.", flush=True)
...
print(f"Fetched {len(apisou_pages)} apisou detail pages.", flush=True)
